<template>
    <div class="modal fade" id="create-railcar-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Create Railcar</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" @click.prevent="createRailcar()">Create</button>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    mounted() {
        Bus.$on('railcar.create', () => {
            $('#create-railcar-modal').modal('show');
        })
    },

    methods: {
        createRailcar() {
            axios.post(`/api/railcars`, this.railcar)
                .then(response => {
                    this.hideModal();
        ...
        hideModal() {
            $('#create-railcar-modal').modal('hide');
        },
